 ...
 */
final class Version20210122154516 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE reservation ADD client_id INT NOT NULL, ADD bien_id INT NOT NULL, ADD etat VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE reservation DROP client_id, DROP bien_id, DROP etat');
    }
}
